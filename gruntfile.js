module.exports = function (grunt)
{
	...
	grunt.initConfig(
	{
		...
		shell:
		{
			...
			apiBase:
			{
				command: 'php vendor/apigen/apigen/apigen.php --template-config ../redaxscript-apigen-template/config.neon --source includes --destination ../redaxscript-api/base'
			},
			apiTests:
			{
				command: 'php vendor/apigen/apigen/apigen.php --template-config ../redaxscript-apigen-template/config.neon --source tests --destination ../redaxscript-api/tests'
			},
			addUpstream:
			{
