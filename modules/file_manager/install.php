...
{
	$query = 'INSERT INTO ' . PREFIX . 'modules (name, alias, author, description, version, status, access) VALUES (\'File manager\', \'file_manager\', \'Redaxmedia\', \'Simple file management\', \'2.1.0\', 1, 1)';
	mysql_query($query);
}
