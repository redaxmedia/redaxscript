...
{
	$query = 'INSERT INTO ' . PREFIX . 'modules (name, alias, author, description, version, status, access) VALUES (\'Feed generator\', \'feed_generator\', \'Redaxmedia\', \'Generate Atom feeds from content\', \'1.2\', 1, 0)';
	mysql_query($query);
}
