...
function router()
{
	...
	{
		$messenger = new Redaxscript\Messenger();
		echo $messenger->setAction(Redaxscript\Language::get('continue'), Redaxscript\Registry::get('parameterRoute') . '/search/' . Redaxscript\Request::getPost('table') . '/' . Redaxscript\Request::getPost('search'))->doRedirect(0)->success(Redaxscript\Language::get('search') . '...');
	}
