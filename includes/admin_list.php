...
function admin_groups_list()
{
	...
	{
		$output .= '<a href="' . Redaxscript\Registry::get('parameterRoute') . 'admin/new/groups" class="rs-admin-button-default">' . Redaxscript\Language::get('group_new') . '</a>';
	}
...
function admin_users_list()
{
	...
	{
		$output .= '<a href="' . Redaxscript\Registry::get('parameterRoute') . 'admin/new/users" class="rs-admin-button-default">' . Redaxscript\Language::get('user_new') . '</a>';
	}
