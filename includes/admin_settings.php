...
function admin_settings_form()
{
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-js-set-active rs-admin-set-accordion rs-set-active">';
	$output .= '<legend class="rs-js-title-accordion rs-js-title-active rs-admin-title-accordion rs-admin-title-active">' . l('general') . '</legend>';
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-admin-set-accordion">';
	$output .= '<legend class="rs-js-title-accordion rs-admin-title-accordion">' . l('metadata') . '</legend>';
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-admin-set-accordion">';
	$output .= '<legend class="rs-js-title-accordion rs-admin-title-accordion">' . l('contact') . '</legend>';
	$output .= '<ul class="rs-js-box-accordion rs-box-accordion rs-admin-box-accordion">';
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-admin-set-accordion">';
	$output .= '<legend class="rs-js-title-accordion rs-admin-title-accordion">' . l('formatting') . '</legend>';
	$output .= '<ul class="rs-js-box-accordion rs-box-accordion rs-admin-box-accordion">';
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-admin-set-accordion">';
	$output .= '<legend class="rs-js-title-accordion rs-admin-title-accordion">' . l('contents') . '</legend>';
	$output .= '<ul class="rs-js-box-accordion rs-box-accordion rs-admin-box-accordion">';
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-admin-set-accordion">';
	$output .= '<legend class="rs-js-title-accordion rs-admin-title-accordion">' . l('comments') . '</legend>';
	$output .= '<ul class="rs-js-box-accordion rs-box-accordion rs-admin-box-accordion">';
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-admin-set-accordion">';
	$output .= '<legend class="rs-js-title-accordion rs-admin-title-accordion">' . l('users') . '</legend>';
	$output .= '<ul class="rs-js-box-accordion rs-box-accordion rs-admin-box-accordion">';
	...
	$output .= '<fieldset class="rs-js-set-accordion rs-js-set-accordion-last rs-admin-set-accordion rs-admin-set-accordion-last">';
	$output .= '<legend class="rs-js-title-accordion rs-admin-title-accordion">' . l('security') . '</legend>';
	$output .= '<ul class="rs-js-box-accordion rs-box-accordion rs-admin-box-accordion">';
