...
function b($name = '')
{
	...
	$b['constant_public'] = 'TOKEN, LOGGED_IN, FIRST_PARAMETER, FIRST_SUB_PARAMETER, SECOND_PARAMETER, SECOND_SUB_PARAMETER, THIRD_PARAMETER, THIRD_SUB_PARAMETER, ADMIN_PARAMETER, TABLE_PARAMETER, ID_PARAMETER, ALIAS_PARAMETER, LAST_PARAMETER, LAST_SUB_PARAMETER, FIRST_TABLE, SECOND_TABLE, THIRD_TABLE, LAST_TABLE, FULL_ROUTE, FULL_TOP_ROUTE, MY_IP, MY_BROWSER, MY_BROWSER_VERSION, MY_ENGINE, MY_DESKTOP, MY_MOBILE, MY_TABLET';
	$output = $b[$name];
	return $output;
}
?>
