...
function b($name = '')
{
	...
	$b['html_tags'] = 'applet, base, basefont, bgsound, body, embed, font, form, frame, frameset, function, head, html, isindex, iframe, ilayer, img, input, layer, link, meta, object, table, title, xml';
