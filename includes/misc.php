...
function b($name = '')
{
	...
	$b['constant_public'] = 'TOKEN, LOGGED_IN, FIRST_PARAMETER, FIRST_PARAMETER_SUB, SECOND_PARAMETER, SECOND_SUB_PARAMETER, THIRD_PARAMETER, THIRD_SUB_PARAMETER, ADMIN_PARAMETER, TABLE_PARAMETER, ID_PARAMETER, ALIAS_PARAMETER, LAST_PARAMETER, LAST_SUB_PARAMETER, FIRST_TABLE, SECOND_TABLE, THIRD_TABLE, LAST_TABLE, FULL_STRING, FULL_TOP_STRING, MY_BROWSER, MY_BROWSER_VERSION, MY_ENGINE, MY_SYSTEM, MY_MOBILE';
	$b['constant_eol'] = '\n';
	$output = $b[$name];
	return $output;
}
