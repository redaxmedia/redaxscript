...
function login_form()
{
	...
	$output .= '<li>' . form_element('text', 'user', 'rs-field-text rs-field-note', 'user', '', l('user'), 'maxlength="50" required="required" autofocus="autofocus"' . $code_disabled) . '</li>';
	$output .= '<li>' . form_element('password', 'password', 'js_unmask_password rs-field-text rs-field-note', 'password', '', l('password'), 'maxlength="50" required="required" autocomplete="off"' . $code_disabled) . '</li>';
	...
	$output .= form_element('button', '', 'rs-js-submit rs-button-default', 'login_post', l('submit'), '', $code_disabled);
	$output .= '</form>';
