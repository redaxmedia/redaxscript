...
function login_form()
{
	...
	$output .= form_element('form', 'form_login', 'js_check_required box_login', '', '', '', 'action="' . REWRITE_STRING . 'login" method="post"');
	...
	$output .= '<li>' . form_element('password', 'password', 'js_required field_text field_note' . $class_disabled, 'password', '', l('password'), 'maxlength="10" required="required"' . $code_disabled) . '</li>';
