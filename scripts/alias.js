...
(function ($)
{
	...
	$.fn.cleanAlias = function (input)
	{
		...
		output = output.replace(/[\u00c4\u00e4\xc6\xe6]/g, 'ae');
		output = output.replace(/[\u0411\u0431\u0392\u03b2\u05d1\u10d1]/g, 'b');
		output = output.replace(/[\u3070\u30d0]/g, 'ba');
		output = output.replace(/[\u3079\u30d9]/g, 'be');
		...
		output = output.replace(/[\u0427\u0447\u03a7\u03c7\u10e9\u10ed]/g, 'ch');
		output = output.replace(/[\u0414\u0434\u010e-\u0111\u0394\u03b4\u05d3\u10d3\xd0\xf0]/g, 'd');
		output = output.replace(/[\u3060\u30c0]/g, 'da');
		output = output.replace(/[\u3067\u30c7]/g, 'de');
		...
		output = output.replace(/[\u0415\u0435\u00c8-\u00ca\u00e8-\u00ea\u0116-\u011b\u0112\u0113\u0388\u0395\u03ad\u03b5\u042d\u044d\u10d4\u1eb8-\u1ec7\u3047\u3048\u30a7\u30a8\xc8-\xcb\xe8-\xeb]/g, 'e');
		output = output.replace(/[\u0424\u0444\u03a6\u03c6]/g, 'f');
		output = output.replace(/[\u0413\u0433\u011c-\u0123\u0393\u03b3\u05d2\u10d2]/g, 'g');
		...
		output = output.replace(/[\u306f\u30cf]/g, 'ha');
		output = output.replace(/[\u3078\u30d8]/g, 'he');
		output = output.replace(/[\u3072\u30d2]/g, 'hi');
		output = output.replace(/[\u307b\u30db]/g, 'ho');
		output = output.replace(/[\u3075\u30d5]/g, 'hu');
		output = output.replace(/[\u00cc\u00cd\u00ec\u00ed\u0128-\u012b\u012e-\u0132\u013a\u0389\u038a\u0390\u0397\u0399\u03aa\u03ae\u03af\u03b7\u03b9\u03ca\u0406\u0418\u0438\u0456\u10d8\u1ec8-\u1ecb\u3043\u3044\u30a3\u30a4\xa1\xcc-\xcf\xec-\xef]/g, 'i');
		output = output.replace(/[\u0404\u0454]/g, 'ie');
		output = output.replace(/[\u0419\u0439\u0134\u0135\u10ef]/g, 'j');
		output = output.replace(/[\u0408\u0458]/g, 'je');
		output = output.replace(/[\u041a\u043a\u0136\u0137\u039a\u03ba\u05d7\u05e7\u10d9]/g, 'k');
		output = output.replace(/[\u304b\u3095\u30ab\u30f5]/g, 'ka');
		output = output.replace(/[\u3051\u3096\u30b1\u30f6]/g, 'ke');
		output = output.replace(/[\u304d\u30ad]/g, 'ki');
		output = output.replace(/[\u0425\u0445\u10ee]/g, 'kh');
		output = output.replace(/[\u040c\u045c]/g, 'kje');
		output = output.replace(/[\u3053\u30b3]/g, 'ko');
		output = output.replace(/[\u304f\u30af]/g, 'ku');
		output = output.replace(/[\u041b\u043b\u0139-\u013e\u0141\u0142\u039b\u03bb\u05dc\u10da]/g, 'l');
		output = output.replace(/[\u0409\u0459]/g, 'lje');
		output = output.replace(/[\u041c\u043c\u039c\u03bc\u05dd\u05de\u10db]/g, 'm');
		...
		output = output.replace(/[\u041d\u043d\u0143-\u0148\u039d\u03bd\u05df\u05e0\u10dc\u3093\u30f3\xd1\xf1]/g, 'n');
		...
		output = output.replace(/[\u00d6\u00f6\u039e\u03be\u0152\u0153]/g, 'oe');
		output = output.replace(/[\u041f\u043f\u03a0\u03c0\u05e3\u05e4\u10de]/g, 'p');
		output = output.replace(/[\u3071\u30d1]/g, 'pa');
		output = output.replace(/[\u307a\u30da]/g, 'pe');
		...
		output = output.replace(/[\u0420\u0440\u0154-\u0159\u03a1\u03c1\u05e8\u10e0]/g, 'r');
		...
		output = output.replace(/[\u0421\u0441\u015a-\u0161\u03a3\u03c2\u03c3\u05e1\u10e1\x8a\x9a\xdf]/g, 's');
		output = output.replace(/[\u3055\u30b5]/g, 'sa');
		output = output.replace(/[\u0428\u0448\u05e9\u10e8]/g, 'sh');
		output = output.replace(/[\u042a]/g, 'shcha');
		output = output.replace(/[\u0429\u0449]/g, 'shh');
		...
		output = output.replace(/[\u00dc\u00fc]/g, 'ue');
		output = output.replace(/[\u0412\u0432\u05d5\u10d5]/g, 'v');
		output = output.replace(/[\u30f7]/g, 'va');
		output = output.replace(/[\u30f9]/g, 've');
		...
		output = output.replace(/[\u042b\u044b\u00da\u00fd\u038e\u03a5\u03ab\u03b0\u03c5\u03cb\u03cd\u05d9\u10e7\u1ef2-\u1ef9\x9f\xdd\xfd\xff]/g, 'y');
		output = output.replace(/[\u042f\u044f\u3083\u3084\u30e3\u30e4]/g, 'ya');
		output = output.replace(/[\u0407\u0457]/g, 'yi');
		output = output.replace(/[\u0401\u0451\u3087\u3088\u30e7\u30e8]/g, 'yo');
		output = output.replace(/[\u042e\u044e\u3085\u3086\u30e5\u30e6]/g, 'yu');
		output = output.replace(/[\u0417\u0437\u0179-\u017e\u0396\u03b6\u05d6\u10d6\x9e]/g, 'z');
		output = output.replace(/[\u3056\u30b6]/g, 'za');
		output = output.replace(/[\u0416\u0436\u10df]/g, 'zh');
