...
function install_form()
{
	...
	$output .= form_element('button', '', 'js_submit button_large', 'install_post', l('install'));
	$output .= '</form>';
	echo $output;
}
