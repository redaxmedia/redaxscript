...
function install()
{
	...
	$r['insert_extras'] = 'INSERT INTO ' . $d_name . '.' . $d_prefix . 'extras (id, title, alias, author, text, language, date, category, article, headline, status, rank, access) VALUES (1, \'Categories\', \'categories\', \'' . $user . '\', \'<function>\n{\n\t"navigation_list":\n\t{\n\t\t"table": "categories",\n\t\t"options":\n\t\t{\n\t\t\t"class": "list_sidebar",\n\t\t\t"children": 1\n\t\t}\n\t}\n}\n</function>\', \'\', \'' . NOW . '\', 0, 0, 1, 1, 1, \'0\'), (2, \'Articles\', \'articles\', \'' . $user . '\', \'<function>\n{\n\t"navigation_list":\n\t{\n\t\t"table": "articles",\n\t\t"options":\n\t\t{\n\t\t\t"class": "list_sidebar"\n\t\t}\n\t}\n}\n</function>\', \'\', \'' . NOW . '\', 0, 0, 1, 1, 2, \'0\'), (3, \'Comments\', \'comments\', \'' . $user . '\', \'<function>\n{\n\t"navigation_list":\n\t{\n\t\t"table": "comments",\n\t\t"options":\n\t\t{\n\t\t\t"class": "list_sidebar"\n\t\t}\n\t}\n}\n</function>\', \'\', \'' . NOW . '\', 0, 0, 1, 1, 3, \'0\'), (4, \'Languages\', \'languages\', \'' . $user . '\', \'<function>\n{\n\t"languages_list":\n\t{\n\t\t"options":\n\t\t{\n\t\t\t"class": "list_sidebar"\n\t\t}\n\t}\n}\n</function>\', \'\', \'' . NOW . '\', 0, 0, 1, 0, 4, \'0\'), (5, \'Templates\', \'templates\', \'' . $user . '\', \'<function>\n{\n\t"templates_list":\n\t{\n\t\t"options":\n\t\t{\n\t\t\t"class": "list_sidebar"\n\t\t}\n\t}\n}\n</function>\', \'\', \'' . NOW . '\', 0, 0, 1, 0, 5, \'0\'), (6, \'Footer\', \'footer\', \'' . $user . '\', \'<div class="box_first grid_space s1o5">\n\t<h3 class="title_footer">\n\t\t<a href="//redaxscript.com/general" title="General">General</a>\n\t</h3>\n\t<ul class="list_footer">\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/general/introduction" title="Introduction">Introduction</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/general/feature-list" title="Feature list">Feature list</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/general/benchmark" title="Benchmark">Benchmark</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/general/service" title="Service">Service</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/general/about" title="About">About</a>\n\t\t</li>\n\t</ul>\n</div>\n\n<div class="box_second grid_space s1o5">\n\t<h3 class="title_footer">\n\t\t<a href="//redaxscript.com/download" title="Download">Download</a>\n\t</h3>\n\t<ul class="list_footer">\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/download/releases" title="Releases">Releases</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/download/templates" title="Templates">Templates</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/download/languages" title="Languages">Languages</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/download/modules" title="Modules">Modules</a>\n\t\t</li>\n\t</ul>\n</div>\n\n<div class="box_third grid_space s1o5">\n\t<h3 class="title_footer">\n\t\t<a href="//redaxscript.com/support" title="Support">Support</a>\n\t</h3>\n\t<ul class="list_footer">\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/support/getting-started" title="Getting started">Getting started</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/support/installation-guide" title="Installation guide">Installation guide</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/support/troubleshooting" title="Troubleshooting">Troubleshooting</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/support/faq" title="FAQ">FAQ</a>\n\t\t</li>\n\t</ul>\n</div>\n\n<div class="box_fourth grid_space s1o5">\n\t<h3 class="title_footer">\n\t\t<a href="//redaxscript.com/develop" title="Develop">Develop</a>\n\t</h3>\n\t<ul class="list_footer">\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/develop/source-code" title="Source code">Source code</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/develop/github-guide" title="Github guide">Github guide</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/develop/documentation" title="Documentation">Documentation</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/develop/roadmap" title="Roadmap">Roadmap</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/develop/changelog" title="Changelog">Changelog</a>\n\t\t</li>\n\t</ul>\n</div>\n\n<div class="box_last grid_space s1o5">\n\t<h3 class="title_footer">\n\t\t<a href="//redaxscript.com/community" title="Community">Community</a>\n\t</h3>\n\t<ul class="list_footer">\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/community/forum" title="Forum">Forum</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/community/facebook-group" title="Facebook group">Facebook group</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/community/team" title="Team">Team</a>\n\t\t</li>\n\t\t<li>\n\t\t\t<a href="//redaxscript.com/community/contribute" title="Contribute">Contribute</a>\n\t\t</li>\n\t</ul>\n</div>\', \'\', \'' . NOW . '\', 0, 0, 0, 0, 6, \'0\')';
