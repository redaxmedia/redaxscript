...
function install()
{
	...
	$r['insert_extras'] = 'INSERT INTO ' . $d_name . '.' . $d_prefix . 'extras (id, title, alias, author, text, language, date, category, article, headline, status, rank, access) VALUES (1, \'Categories\', \'categories\', \'' . $user . '\', \'<php>navigation_list(\'categories\', array(\'children\' => 1));</php>\', \'\', \'' . NOW . '\', 0, 0, 1, 1, 1, \'0\'), (2, \'Articles\', \'articles\', \'' . $user . '\', \'<php>navigation_list(\'articles\'));</php>\', \'\', \'' . NOW . '\', 0, 0, 1, 1, 2, \'0\'), (3, \'Comments\', \'comments\', \'' . $user . '\', \'<php>navigation_list(\'comments\'));</php>\', \'\', \'' . NOW . '\', 0, 0, 1, 1, 3, \'0\'), (4, \'Languages\', \'languages\', \'' . $user . '\', \'<php>languages_list();</php>\', \'\', \'' . NOW . '\', 0, 0, 1, 0, 4, \'0\'), (5, \'Templates\', \'templates\', \'' . $user . '\', \'<php>templates_list();</php>\', \'\', \'' . NOW . '\', 0, 0, 1, 0, 5, \'0\'), (6, \'Footer\', \'footer\', \'' . $user . '\', \'<div class=\"box_first grid_space s1o5\"><h3 class=\"title_footer\">Lorem ipsum</h3><ul class=\"list_footer\"><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li></ul></div><div class=\"box_second grid_space s1o5\"><h3 class=\"title_footer\">Lorem ipsum</h3><ul class=\"list_footer\"><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li></ul></div><div class=\"box_third grid_space s1o5\"><h3 class=\"title_footer\">Lorem ipsum</h3><ul class=\"list_footer\"><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li></ul></div><div class=\"box_fourth grid_space s1o5\"><h3 class=\"title_footer\">Lorem ipsum</h3><ul class=\"list_footer\"><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li><li><a>Lorem ipsum</a></li></ul></div><div class=\"box_last grid_space s1o5\"><h3 class=\"title_footer\"><php>echo l(\'administration\')</php></h3><php>login_list();</php></div>\', \'\', \'' . NOW . '\', 0, 0, 0, 0, 6, \'0\')';
	...
	{
		$r['insert_modules'] = 'INSERT INTO ' . $d_name . '.' . $d_prefix . 'modules (name, alias, author, description, version, status, access) VALUES (\'Call home\', \'call_home\', \'Redaxmedia\', \'Call home module\', \'1.2.1\', 1, 0)';
	}
